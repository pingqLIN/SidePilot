...
> 本指南涵蓋每項功能的詳細說明。如需快速設定，請參閱 [README.zh-TW.md](../README.zh-TW.md)。
...
```bash
node --version    # 應輸出 v18.x.x 或更高版本
```
